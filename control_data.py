...
def txt_extract_and_filter(s_file_path, d_file_path, save_on):
    ...
    for action in number_to_string(action_nos):
        ...
        for subject in number_to_string(subject_nos):
            ...
            print(f'Extracting and filtering: {file_name}')
    ...
    if save_on:
        new_file_name = 'skeleton_coord_data_points.csv'
...
def main():
    ...
    filt_skel_points_df = txt_extract_and_filter(source_file_path, dest_file_path, True)
